...
#### Para domínio principal (exemplo: anaissidata.com.br):
```
Tipo: A
Nome: @
Valor: 76.76.19.61
...
#### Para subdomínio www (exemplo: www.anaissidata.com.br):
```
Tipo: CNAME
Nome: www
...
2. Digite seu domínio: `anaissidata.com.br`
3. Clique em "Add Domain"

### 2.3 Configure o Subdomínio www:
1. Clique em "Add Custom Domain"
2. Digite: `www.anaissidata.com.br`
3. Clique em "Add Domain"
...
```
@           A       76.76.19.61
www         CNAME   anaissidata.onrender.com
api         CNAME   anaissidata.onrender.com
```

### Custom Domains (Render):
```
anaissidata.com.br
www.anaissidata.com.br
```
