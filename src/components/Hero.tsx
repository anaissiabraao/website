      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 py-8 md:py-0">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-5 md:space-y-8 animate-fade-in-up text-center lg:text-left">
            ...
            <p className="text-base md:text-lg lg:text-xl text-primary-foreground/80 max-w-xl mx-auto lg:mx-0">
              {t("hero.preSavings")}{" "}
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 text-primary-foreground/70 text-xs md:text-sm">
              <Clock className="h-3 w-3 md:h-4 md:w-4 text-primary flex-shrink-0" />
              <span>
                <strong className="text-primary-foreground">{t("hero.urgency")}</strong>{" "}
                {t("hero.urgencyText")}
              </span>
            </div>
          </div>
